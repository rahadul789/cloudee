...
import { adminExternalDeliveryRouter } from "../modules/admin/external-delivery-admin.routes";
import { adminFinanceRouter } from "../modules/admin/finance.routes";
import { adminMenuApprovalsRouter } from "../modules/admin/menu-approvals.routes";
...
apiRouter.use("/admin", adminExternalDeliveryRouter);
apiRouter.use("/admin", adminFinanceRouter);
apiRouter.use("/admin", adminMenuApprovalsRouter);
