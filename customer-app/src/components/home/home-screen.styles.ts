...
export const styles = StyleSheet.create({
  ...
  restaurantSkeletonCardOffer: {
  },
  restaurantSkeletonCardNearby: {
  },
  restaurantSkeletonImageShell: {
    position: "relative",
    height: 148,
    overflow: "hidden",
    backgroundColor: "#FFF0F6",
  ...
  restaurantSkeletonImageFeatured: {
  },
  restaurantSkeletonImageOffer: {
  },
  restaurantSkeletonImageNearby: {
  },
  restaurantSkeletonImageBadge: {
    position: "absolute",
    left: 8,
    bottom: 8,
    width: 82,
  ...
  restaurantSkeletonImageBadgeNearby: {
    width: 76,
    backgroundColor: "#EDF4FF",
  },
  restaurantSkeletonOfferBadge: {
    position: "absolute",
    right: 8,
    bottom: 8,
    width: 92,
  ...
  restaurantSkeletonCopyOffer: {
  },
  restaurantSkeletonOfferStrip: {
    width: "100%",
    height: 31,
    borderRadius: 12,
    backgroundColor: "#FFF0F6",
  ...
  browseAllButton: {
    ...
    borderRadius: 22,
    borderWidth: 1,
    borderColor: "rgba(216, 27, 96, 0.16)",
