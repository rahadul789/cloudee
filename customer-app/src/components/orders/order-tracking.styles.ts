...
export const styles = StyleSheet.create({
  ...
  orderSuccessCard: {
    ...
    borderRadius: 34,
    borderWidth: 1,
    borderColor: "rgba(20, 152, 91, 0.16)",
  ...
  orderSuccessIconOuter: {
    ...
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: "rgba(20, 152, 91, 0.1)",
  },
  orderSuccessIconInner: {
    ...
    backgroundColor: palette.successSurface,
    borderWidth: 1,
    borderColor: "rgba(20, 152, 91, 0.18)",
  },
  orderSuccessTitle: {
    marginTop: 4,
    fontSize: 25,
